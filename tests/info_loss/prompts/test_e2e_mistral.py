...
from info_loss.prompts.e2e_mistral import parse_response

response = """
## Omissions
- Original Fragment: "oral"
...
def test_parse_reponse_special():
    response = textwrap.dedent(
        """
        ## Omissions
        - Original Fragment: "They were divided into four groups as follows: a, b, c, d"
        - Simplification Fragment: null
        ...
        ## Imprecise/fuzzy concepts
        - Original Fragment: "postoperative eye-opening and extubation time"
        - Simplification Fragment: "time taken for patients to open their eyes and to remove the breathing tube post surgery"
